...
-  Added ``Broader Perspective`` (discussing cloudification) to the end
   ...
   1.8 <https://github.com/SystemsApproach/foundation/blob/v5.4/trend.md>`__
-  Added overview of VXLAN to `Section
   3.5 <https://github.com/SystemsApproach/internetworking/blob/v5.4/trend.md>`__
-  Added discussion of Cloud’s impact on Internet structure to `Section
   4.5 <https://github.com/SystemsApproach/scaling/blob/v5.4/trend.md>`__
-  Added description of HTTP adaptive streaming to `Section
   7.2 <https://github.com/SystemsApproach/data/blob/v5.4/multimedia.md>`__
-  Added new `Section
   8.1 <https://github.com/SystemsApproach/security/blob/v5.4/trust.md>`__
   to discuss *threats* and *trust*
-  Added description of decentralized identity management to `Section
   8.6 <https://github.com/SystemsApproach/security/blob/v5.4/trend.md>`__
-  Added description more recent management systems to `Section
   9.3 <https://github.com/SystemsApproach/applications/blob/v5.4/infrastructure.md>`__
...
-  Added description of gRPC to `Section
   5.3 <https://github.com/SystemsApproach/e2e/blob/v5.3/rpc.md>`__
-  Added description of CUBIC to `Section
   6.3 <https://github.com/SystemsApproach/congestion/blob/v5.3/tcpcc.md>`__
-  Added descriptions of DCTCP and BBR to `Section
   6.4 <https://github.com/SystemsApproach/congestion/blob/v5.3/avoidance.md>`__
-  Added discussion of AQM and ECN to `Section
   6.4 <https://github.com/SystemsApproach/congestion/blob/v5.3/avoidance.md>`__
-  Added description of Protocol Buffers to `Section
   7.1 <https://github.com/SystemsApproach/data/blob/v5.3/presentation.md>`__
-  Added description of HTTP/2 to `Section
   9.1 <https://github.com/SystemsApproach/applications/blob/v5.3/traditional.md>`__
...
-  Expanded discussion of fiber-to-the-home and 5G to `Section
   2.8 <https://github.com/SystemsApproach/direct/blob/v5.2/access.md>`__
-  Updated switch implementation description in `Section
   3.4 <https://github.com/SystemsApproach/internetworking/blob/v5.2/impl.md>`__
